...
;              LED_TYPE in  [from SuperCIC pin 7] |7  C3 C2  8| Cart-Region [from SuperCIC pin 3]
;                                                 `-----------'
;
;
...
;
;   D-Pad up     enable region timeout                           0xd7 0xcf
;   D-Pad down   disable region timeout                          0xdb 0xcf
;
;   Temporary Lock:
...
M_setAuto   macro   ; set modeout to auto
            btfsc   PORTC, CART_MODE_IN
            set50Hz
            btfss   PORTC, CART_MODE_IN
            set60Hz
            endm
...
groupcf ; check L+R+sel+...
    ...
    M_belf  0xd7, reg_ctrl_data_msb, enable_regtimeout  ; Up
    M_belf  0xdb, reg_ctrl_data_msb, disable_regtimeout ; Down
...
enable_regtimeout
    bsf     reg_current_mode, bit_regtimeout
    call    save_mode
...
disable_regtimeout
    bcf     reg_current_mode, bit_regtimeout
    call    save_mode
